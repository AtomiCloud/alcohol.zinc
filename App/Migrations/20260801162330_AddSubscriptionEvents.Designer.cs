...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Modules.Disbursement.Data.DisbursementData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PledgeOrganizationId")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
            ...
            modelBuilder.Entity("App.Modules.NfcTag.Data.NfcTagData", b =>
                {
            ...
            modelBuilder.Entity("App.Modules.Penalty.Data.CharityBalanceData", b =>
                {
                    ...
                    b.HasIndex("CharityId", "Currency")
                        .IsUnique();

                    b.ToTable("CharityBalances");
                });

            modelBuilder.Entity("App.Modules.Penalty.Data.PenaltyData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("HabitExecutionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Status", "DisbursementId");
            ...
            modelBuilder.Entity("App.Modules.Subscription.Data.SubscriptionEventData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ChargeIntentId")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
            ...
            modelBuilder.Entity("App.Modules.Subscription.Data.UserSubscriptionData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("LastChargeIntentId")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");

                    b.Property<string>("LastChargeKey")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.Property<DateTime?>("RenewingUntil")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("App.Modules.Penalty.Data.PenaltyData", b =>
                {
                    ...
                    b.HasOne("App.Modules.Disbursement.Data.DisbursementData", null)
                        .WithMany()
                        .HasForeignKey("DisbursementId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("App.Modules.HabitExecution.Data.HabitExecutionData", "HabitExecution")
                        .WithMany()
                        .HasForeignKey("HabitExecutionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
